...
function HeroSection() {
  return (
    <section className="relative bg-[url('/images/profile-bg-5.webp')] bg-cover bg-center bg-no-repeat px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center justify-center h-screen space-y-4">
        <div className="relative">
          <h3 className="text-center font-urbanist text-2xl/15 md:text-3xl/18 mt-4 font-bold max-w-2xl">
            Hi, my name is
          </h3>
